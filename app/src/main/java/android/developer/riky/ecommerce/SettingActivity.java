...
//                intent.putExtra("settings", "check");
    ...
    private void userInfoSaved()
    {
        ...
        {
            Toast.makeText(this, "Number is Phone", Toast.LENGTH_SHORT).show();
        }
    ...
    private void uploadImage()
    {
        ...
        progressDialog.setMessage("Please wait, Update your profile");
        ...
        if (imageUri != null)
        {
            final StorageReference fileRef = storageProfilePrictureRef
                    .child(Prevalent.currentOnlineUser.getPhone() + ".jpg" + ".png");
            ...
            uploadTask.continueWithTask(new Continuation() {
                ...
                public Object then(@NonNull Task task) throws Exception
                {
                    ...
                    // tambah ini jika code error getResult <Uri>
